...
public class WaferDataServiceImpl implements WaferDataService {
    ...
    public WaferResult query(QueryRequest request) {
        ...
        List<Map<String, Object>> rows = List.of(
                Map.of("waferId", "W001", "machine", "NXE3600", "product", "ProductA", "yieldPct", 72.3,
                        "defectDensity", 0.42),
                Map.of("waferId", "W002", "machine", "NXE3600", "product", "ProductA", "yieldPct", 69.1,
                        "defectDensity", 0.51),
                Map.of("waferId", "W003", "machine", "NXE3600", "product", "ProductA", "yieldPct", 71.8,
                        "defectDensity", 0.44),
                Map.of("waferId", "W004", "machine", "NXE3600", "product", "ProductA", "yieldPct", 55.2,
                        "defectDensity", 1.23),
                Map.of("waferId", "W005", "machine", "NXE3600", "product", "ProductA", "yieldPct", 56.0,
                        "defectDensity", 1.18));
