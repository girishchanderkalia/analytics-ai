...
class AgentRepository:
    ...
    def list_agent_directories(self) -> list[str]:
        """Return repository directory names containing definitions."""
...
def load_agent_definition(
    ...
    if not definitions_directory.is_dir():
        raise AgentDefinitionError(
            "Agent definitions directory does not exist: "
            f"{definitions_directory}"
        )
...
def build_argument_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        default=(
            ...
            "ai-agents/opo-monitoring"
        ),
        help=(
            "Path to the application-agent directory. "
            "The directory must contain definitions/."
        ),
    )
