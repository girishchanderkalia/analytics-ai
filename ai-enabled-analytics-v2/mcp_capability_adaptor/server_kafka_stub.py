"""Kafka MCP server (boundary placeholder, not wired into the OPO workflow).

Kafka is internal to Analytics Foundation and is not exposed as an MCP tool per
...
mcp = FastMCP("analytics-foundation-kafka-stub")
